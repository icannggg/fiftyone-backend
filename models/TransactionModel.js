...
async function createTransaction(user_id, product_id, product, amount, price, tot_price) {
  ...
  const [results] = await connection.execute(
    'INSERT INTO transactions (code_trans, user_id, product_id, product, amount, price, tot_price, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
    [code_trans, user_id, product_id, product, amount, price, tot_price, createdAt]
  );
